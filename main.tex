...
I assembled the required flexible spring parts in reference to Figure \ref{fig:diagram} out of TPU, and the links out of PLA for stiffness. 
...
This doesn't mean the total build is a failure, though, as this experiment can still demonstrate when Braess's paradox occures, and the experimental spring data serves as a foundation for understanding the mechanism's behavior despite these deviations from theory.
...
I poke a paper clip through a plastic bag and thread the paperclip through the lower end of the mechanism, I now have a basket. I measure the device in this setup with the pair of calipers without any extra weight in the bag. This is the rest distance applied in the later table.
